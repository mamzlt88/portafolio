...
gallery:
  - file: "01-hero-signup.webp"
    alt: "Hero — platform sign-up on laptop"
  - file: "02-platform-overview.webp"
    alt: "Multi-device platform overview"
  - file: "03-stylescape.webp"
    alt: "Stylescape — visual direction"
  - file: "04-research-board.webp"
    alt: "Research board — strategy and pain points"
  - file: "05-user-flows.webp"
    alt: "User flows and journey maps"
  - file: "06-player-profile.webp"
    alt: "Player profile page"
  - file: "07-team-roster.webp"
    alt: "Team roster and subscriptions"
  - file: "08-content-cards.webp"
    alt: "Content cards and article layouts"
  - file: "09-ui-kit-core.webp"
    alt: "UI kit core components"
  - file: "10-design-system-overview.svg"
    alt: "Design system components overview"
  - file: "11-accordion-components.webp"
    alt: "Accordion components"
  - file: "12-alert-components.webp"
    alt: "Alert components"
  - file: "21-design-system-components.mp4"
    alt: "Design system components walkthrough"
    type: "video"
  - file: "13-chip-components.webp"
    alt: "Chip components"
  - file: "14-button-filled-states.webp"
    alt: "Button states — filled"
  - file: "22-design-system-foundation.mp4"
    alt: "Design system foundation walkthrough"
    type: "video"
  - file: "15-button-text-states.webp"
    alt: "Button states — text"
  - file: "16-player-cutout.webp"
    alt: "Player cutout visual"
  - file: "23-design-system-extended.mp4"
    alt: "Design system extended components walkthrough"
    type: "video"
  - file: "17-coach-cutout.webp"
    alt: "Coach cutout visual"
  - file: "18-brand-hero.svg"
    alt: "Brand hero illustration"
  - file: "19-reels-demo.mp4"
    alt: "Platform reels demo"
    type: "video"
  - file: "20-scene-walkthrough.mp4"
    alt: "Platform scene walkthrough"
    type: "video"
  - file: "24-hero-highlight.mp4"
    alt: "Hero highlight video"
    type: "video"
---
...
As the business expanded into streaming, subscriptions, and digital engagement, its platform required a more scalable and unified ecosystem.

This project was part of a broader transformation initiative aimed at integrating content, streaming, customer engagement, and data into a cohesive platform.
...
- Content and editorial workflows (CMS)
- Customer and sponsor management (CRM)
- Streaming and video infrastructure
- Analytics and business intelligence

Each system had evolved independently, resulting in a fragmented experience for both users and internal teams.
...
As the platform evolved, multiple systems had grown in isolation. Content, streaming, subscriptions, and customer data were not fully connected, creating friction across the experience.

Users experienced this as:

- Disconnected journeys between content, live games, and subscriptions
- Confusion around navigation and platform structure
- Inconsistent branding and interaction patterns

From a business and system perspective:

- There was no unified architecture to support growth
- Data and insights were fragmented across systems
- Monetization opportunities were limited by disconnected experiences
- Operational complexity increased as new features were added
...
Branding discovery explored how the platform could better reflect the identity and emotional connection of sports culture.
...
- Enabled stakeholder validation
...
- Navigation clarity
- Content discovery
- Subscription and streaming flows
...
- UI Kit ready for implementation
...
| --- | --- | --- |
| **User Experience** | Fragmented journeys | Unified content, streaming, and subscription flows |
| **Branding** | Inconsistent identity | Clear and cohesive visual direction |
| **UX Structure** | Undefined flows | Structured IA and user journeys |
...
- Early alignment reduces complexity later
