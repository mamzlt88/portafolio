  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[7px] items-start justify-center not-italic px-[40px] py-0 relative w-full">
          ...
          <p className="font-['Poppins',_sans-serif] leading-[22px] relative shrink-0 text-[18px] text-nowrap text-right text-white tracking-[-1px] whitespace-pre">{`Head of Product and Design  `}</p>
          <p className="font-['Trim',_'Courier_New',_monospace] leading-[20.4px] relative shrink-0 text-[12px] text-white w-[313px] whitespace-pre-wrap">{`Leading a multidisciplinary team of 30+ designers, business analysts, and strategists across Latin America. Focused on talent development, operational excellence, and strategic alignment with client goals. Participates in strategic discussions to position design as a business enabler.  `}</p>
        </div>
      </div>
    </div>
  );
...
function Container1() {
  return (
    <div className="content-stretch flex gap-[110px] items-center justify-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Trim',_'Courier_New',_monospace] leading-[16.5px] not-italic relative shrink-0 text-[#f3f9ae] text-[14px] text-right tracking-[0.5px] uppercase w-[322px]">2023–Present</p>
      <Content />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-end justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[7px] items-end justify-center not-italic px-[40px] py-0 relative text-right w-full">
          ...
          <p className="font-['Poppins',_sans-serif] leading-[22px] relative shrink-0 text-[18px] text-nowrap text-white tracking-[-1px] whitespace-pre">
    ...
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[73px] items-center justify-center pl-[74px] pr-0 py-0 relative w-full">
          <Content1 />
          <p className="basis-0 font-['Trim',_'Courier_New',_monospace] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#f3f9ae] text-[14px] tracking-[0.8px] uppercase">2020–2023</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[7px] items-start justify-center not-italic px-[40px] py-0 relative w-full">
          <p className="font-['Trim',_'Courier_New',_monospace] leading-[16.5px] relative shrink-0 text-[#f3f9ae] text-[11px] text-nowrap text-right tracking-[0.5px] uppercase whitespace-pre">{`Endava  `}</p>
          <p className="font-['Poppins',_sans-serif] leading-[22px] relative shrink-0 text-[18px] text-nowrap text-right text-white tracking-[-1px] whitespace-pre">{`Senior Visual Designer  `}</p>
          <p className="font-['Trim',_'Courier_New',_monospace] leading-[20.4px] relative shrink-0 text-[12px] text-white w-[313px] whitespace-pre-wrap">{`Designed UI systems and digital interfaces for fintech clients. Mentored junior designers and contributed to the creation of internal design standards and processes.  `}</p>
        </div>
      </div>
    </div>
  );
...
function Container5() {
  return (
    <div className="content-stretch flex gap-[110px] items-center justify-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Trim',_'Courier_New',_monospace] leading-[16.5px] not-italic relative shrink-0 text-[#f3f9ae] text-[14px] text-right tracking-[0.5px] uppercase w-[322px]">2018–2020</p>
      <Content2 />
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-end justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[7px] items-end justify-center not-italic px-[40px] py-0 relative text-right w-full">
          ...
          <p className="font-['Poppins',_sans-serif] leading-[22px] relative shrink-0 text-[18px] text-nowrap text-white tracking-[-1px] whitespace-pre">Visual Designer</p>
          <p className="font-['Trim',_'Courier_New',_monospace] leading-[20.4px] relative shrink-0 text-[12px] text-white w-[313px] whitespace-pre-wrap">{`Worked on brand identity, campaign design, and motion graphics for LATAM and U.S. markets. Focused on storytelling through corporate imagery and digital communication.  `}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[73px] items-center justify-center pl-[74px] pr-0 py-0 relative w-full">
          <Content3 />
          <p className="basis-0 font-['Trim',_'Courier_New',_monospace] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#f3f9ae] text-[14px] tracking-[0.8px] uppercase">2016–2018</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[7px] items-start justify-center not-italic px-[40px] py-0 relative w-full">
          ...
          <p className="font-['Poppins',_sans-serif] leading-[22px] relative shrink-0 text-[18px] text-nowrap text-right text-white tracking-[-1px] whitespace-pre">{`Founder &  Visual Designer`}</p>
          <p className="font-['Trim',_'Courier_New',_monospace] leading-[20.4px] relative shrink-0 text-[12px] text-white w-[313px] whitespace-pre-wrap">{`Founded a design boutique specializing in  consulting in branding and digital identity for Latin American clients. Developed logos, brand systems, and Landing pages.`}</p>
        </div>
      </div>
    </div>
  );
...
function Container9() {
  return (
    <div className="content-stretch flex gap-[110px] items-center justify-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Trim',_'Courier_New',_monospace] leading-[16.5px] not-italic relative shrink-0 text-[#f3f9ae] text-[14px] text-right tracking-[0.5px] uppercase w-[322px]">2016–2018</p>
      <Content4 />
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-end justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[7px] items-end justify-center not-italic px-[40px] py-0 relative text-right w-full">
          ...
          <p className="font-['Poppins',_sans-serif] leading-[22px] relative shrink-0 text-[18px] text-nowrap text-white tracking-[-1px] whitespace-pre">Graphic Designer</p>
          <p className="font-['Trim',_'Courier_New',_monospace] leading-[20.4px] relative shrink-0 text-[12px] text-white w-[313px]">Created digital assets and marketing materials for social and web campaigns. Collaborated with creative teams to build visual consistency and improve digital communication.</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[73px] items-center justify-center pl-[74px] pr-0 py-0 relative w-full">
          <Content5 />
          <p className="basis-0 font-['Trim',_'Courier_New',_monospace] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#f3f9ae] text-[14px] tracking-[0.8px] uppercase">2016</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[7px] items-start justify-center not-italic px-[40px] py-0 relative w-full">
          ...
          <p className="font-['Poppins',_sans-serif] leading-[22px] relative shrink-0 text-[18px] text-nowrap text-right text-white tracking-[-1px] whitespace-pre">Art Director Jr</p>
...
function Container13() {
  return (
    <div className="content-stretch flex gap-[110px] items-center justify-center relative shrink-0 w-full" data-name="Container">
      <p className="font-['Trim',_'Courier_New',_monospace] leading-[18px] not-italic relative shrink-0 text-[#f3f9ae] text-[14px] text-right tracking-[0.8px] uppercase w-[322px]">{`2011–2014 `}</p>
      <Content6 />
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-end justify-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[7px] items-end justify-center not-italic px-[40px] py-0 relative text-right w-full">
          <p className="font-['Trim',_'Courier_New',_monospace] leading-[15px] relative shrink-0 text-[#f3f9ae] text-[10px] text-nowrap tracking-[0.5px] uppercase whitespace-pre">{`Photo Editor & Production Assistant`}</p>
          <div className="font-['Poppins',_sans-serif] leading-[22px] relative shrink-0 text-[18px] text-nowrap text-white tracking-[-1px] whitespace-pre">
            <p className="mb-0">{`Freelance & Early `}</p>
            <p>Creative Roles</p>
          </div>
          <p className="font-['Trim',_'Courier_New',_monospace] leading-[17.6px] relative shrink-0 text-[11px] text-white w-[313px]">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[73px] items-center justify-center pl-[74px] pr-0 py-0 relative w-full">
          <Content7 />
          <p className="basis-0 font-['Trim',_'Courier_New',_monospace] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#f3f9ae] text-[14px] tracking-[0.8px] uppercase">2011</p>
        </div>
      </div>
    </div>
  );
...
function Timeline8() {
  return (
    <div className="box-border content-stretch flex flex-col items-start pb-0 pt-[40px] px-0 relative shrink-0 w-[864px]" data-name="Timeline">
      <Container1 />
      <Container3 />
      <Container5 />
      <Container7 />
...
function Frame7({ onClickSkills }: { onClickSkills?: () => void }) {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] items-start left-[174px] top-[120px] z-20">
      <p className="font-['Trim',_'Courier_New',_monospace] leading-[28.8px] not-italic relative shrink-0 text-[32px] text-nowrap text-white tracking-[0.8px] uppercase whitespace-pre">Timelines</p>
