...
function Project2({ onClick }: { onClick: () => void }) {
  return (
    <div
      onClick={onClick}
      className="[grid-area:3_/_2] box-border content-stretch flex flex-col gap-[5px] items-end justify-center px-[22px] py-[16px] md:px-[16px] relative overlay-card shrink-0 cursor-pointer"
      data-name="Project 3"
    >
      <div className="content-stretch flex gap-[4px] md:gap-[8px] items-center justify-end leading-[1.12] relative shrink-0 text-black text-nowrap w-full whitespace-pre">
        <p className="font-['Poltawski_Nowy:Bold',sans-serif] font-bold relative shrink-0 tracking-[-0.04em]" style={{ fontSize: 'clamp(1.5rem, 4vw, 3.625rem)' }}>Sports</p>
        <p className="font-['Poppins:SemiBold_Italic',sans-serif] italic relative shrink-0 tracking-[-0.04em]" style={{ fontSize: 'clamp(1.5rem, 4vw, 3.75rem)' }}>Media</p>
      </div>
      <div className="content-stretch flex gap-[4px] md:gap-[8px] items-start justify-end leading-[1.12] relative shrink-0 text-black text-nowrap w-full whitespace-pre">
        <p className="font-['Poppins:Regular',sans-serif] not-italic relative shrink-0 tracking-[-0.04em]" style={{ fontSize: 'clamp(1.5rem, 4vw, 3.6875rem)' }}>Digital</p>
        <p className="font-['Poltawski_Nowy:SemiBold_Italic',sans-serif] font-semibold italic relative shrink-0 tracking-[-0.04em]" style={{ fontSize: 'clamp(1.5rem, 4vw, 3.625rem)' }}>Ecosystem</p>
      </div>
    </div>
  );
}

function Project3({ onClick }: { onClick: () => void }) {
  return (
    <div
      onClick={onClick}
      className="[grid-area:4_/_1] box-border content-stretch flex flex-col gap-[5px] items-start justify-center px-[22px] py-[16px] md:px-[16px] relative overlay-card shrink-0 cursor-pointer"
      data-name="Project 4"
    >
      <div className="content-stretch flex gap-[4px] md:gap-[8px] items-center leading-[1.12] relative shrink-0 text-black text-nowrap w-full whitespace-pre">
        <p className="font-['Poltawski_Nowy:Bold',sans-serif] font-bold relative shrink-0 tracking-[-0.04em]" style={{ fontSize: 'clamp(1.5rem, 4vw, 3.625rem)' }}>Process</p>
        <p className="font-['Poppins:SemiBold_Italic',sans-serif] italic relative shrink-0 tracking-[-0.04em]" style={{ fontSize: 'clamp(1.5rem, 4vw, 3.75rem)' }}>Redesign</p>
      </div>
      <div className="content-stretch flex gap-[4px] md:gap-[8px] items-center leading-[1.12] relative shrink-0 text-black text-nowrap w-full whitespace-pre">
        <p className="font-['Poppins:Regular',sans-serif] not-italic relative shrink-0 tracking-[-0.04em]" style={{ fontSize: 'clamp(1.5rem, 4vw, 3.6875rem)' }}>&amp;</p>
        <p className="font-['Poltawski_Nowy:SemiBold_Italic',sans-serif] font-semibold italic relative shrink-0 tracking-[-0.04em]" style={{ fontSize: 'clamp(1.5rem, 4vw, 3.625rem)' }}>Unification</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[#e1f40b] relative size-full overflow-hidden" data-name="Portfolio-Casestudy">
      <div className="size-full">
        <div className="box-border gap-[8px] md:gap-[10px] grid grid-cols-[repeat(2,_minmax(0px,_1fr))] grid-rows-[repeat(4,_minmax(0px,_1fr))] p-[20px] md:p-[32px] lg:p-[40px] relative size-full">
          ...
          <Project2 onClick={() => onProjectClick('sports-media')} />
          <Project3 onClick={() => onProjectClick('unified-health')} />
